    ...
    <footer class="footer">
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-links">
                    ...
                    <div class="footer-column">
                        <h4>Contact</h4>
                        <ul>
                            <li><a href="mailto:contact@dramealgorix.com">contact@dramealgorix.com</a></li>
                            <li><a href="tel:+221781622782">+221 78 162 27 82</a></li>
                            <li>Dakar, Sénégal</li>
                        </ul>
                    </div>
                    <div class="footer-column">
            ...
            <div class="footer-bottom">
                <p>&copy; 2026 DRAME ALGORIX. Tous droits réservés.</p>
                <a href="https://drive.google.com/file/d/1IYiq5hnFpl_rKLBDL0pR4NJHMQWqo3rx/view?usp=drive_link" class="cv-link">Télécharger mon CV</a>
            </div>
        </div>
    </footer>